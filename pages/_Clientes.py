...
def clientes_page():
    ...
    menu = ["Adicionar Cliente", "Buscar Clientes", "Editar Clientes"]
    ...
    if choice == "Adicionar Cliente":
        ...
        if clientes:
            for cliente in clientes:
                ...
                with st.form(key=f"edit_form_{cliente.customer_id}"):
                    ...
                    if st.form_submit_button("Salvar Alterações"):
                        if not novo_nome.strip():
                            ...
                            session.commit()
                            st.success(f"Dados do cliente {cliente.nome} atualizados com sucesso!")
